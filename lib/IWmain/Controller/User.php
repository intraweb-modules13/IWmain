...
class IWmain_Controller_User extends Zikula_Controller
{
    ...
    */
    public function main()
    {
        ...
        $view->assign('blockFlaggedDetails', $blockFlaggedDetails);
        $view->assign('gCalendarUse', $gCalendarUse);
        $view->assign('gUserName', $gUserName);
        $view->assign('gRefreshTime', $gRefreshTime);
        $view->assign('photo', $photo);
        $view->assign('photo_s', $photo_s);
